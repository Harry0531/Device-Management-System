...
let app = new Vue({
    ...
    data: {
        ...
        urls: {
            ...
            insertOrUpdateComputer: 'http://localhost:8444/api/computer/confidential/insertOrUpdateComputer',
            deleteListByIds: 'http://localhost:8444/api/computer/confidential/deleteListByIds',
            deleteAll: 'http://localhost:8444/api/computer/confidential/deleteAll',
            scrap: 'http://localhost:8444/api/computer/confidential/scrap'
        },
        activeNames: [],
        filters: {
            selectionList: {
