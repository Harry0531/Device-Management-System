...
let defaultDialog = {
    ...
    selectionList: {
        type: [],
        secret_level: [{'value': '9d5b8e19427143f59b23f973464468db', 'label': '非密'}],
        usage: [{'value': '5d8b70afe7f9447f907671600c9642d6', 'label': '非密中转'}],
        use_situation: [],
        subject: [],
        department: [],
        os_version: [],
...
let app = new Vue({
    ...
    data: {
        ...
        loading: false,
        urls: {
            getSub: 'http://localhost:8444/api/computer/intermediary/getSub',
            getDeptSub: 'http://localhost:8444/api/computer/intermediary/getDeptSub',
            getList: 'http://localhost:8444/api/computer/intermediary/getList',
            insertOrUpdateComputer: 'http://localhost:8444/api/computer/intermediary/insertOrUpdateComputer',
            deleteListByIds: 'http://localhost:8444/api/computer/intermediary/deleteListByIds',
            deleteAll: 'http://localhost:8444/api/computer/intermediary/deleteAll',
        },
        activeNames: [],
        filters: {
            selectionList: {
...
function getExportConditions() {
    ...
    let data = {
        ...
        idList: ID,
        isScrapped: false,
        tableName: "non_confidential_intermediary"
    }
    return data;
}
